    ...
    public ResponseEntity<?> registerMeeting(@RequestBody Meeting meeting) {
        ...
        if (foundMeeting != null) {
            return new ResponseEntity(
                    "Unable to create. A meeting with an id " + meeting.getId() + " already exist.", HttpStatus.CONFLICT);
        }
//        foundMeeting = meetingService.findByTitle(meeting.getTitle());
//        if (foundMeeting != null) {
//            return new ResponseEntity(
//                    "Unable to create. A meeting with a title " + meeting.getTitle() + " already exist.", HttpStatus.CONFLICT);
//        }
    ...
    public ResponseEntity<?> removeParticipantFromMeeting(@PathVariable("id") long id, @RequestBody Participant participant) {
        ...
        Participant foundParticipant = participantService.findByLogin(participant.getLogin());
        if (foundParticipant == null) {
            return new ResponseEntity("Participant " + participant + " not found", HttpStatus.NOT_FOUND);
        }
