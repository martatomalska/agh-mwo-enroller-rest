...
public class ParticipantRestController {
	...
	public ResponseEntity<?> getParticipants() {    //pobiera wszystkich uczestników
		Collection<Participant> participants = participantService.getAll();
		return new ResponseEntity<Collection<Participant>>(participants, HttpStatus.OK);  //zwraca kolekcję wszystkich uczestników
	}
